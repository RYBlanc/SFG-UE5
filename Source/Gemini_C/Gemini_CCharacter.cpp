...
AGemini_CCharacter::AGemini_CCharacter()
{
...
void AGemini_CCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AGemini_CCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGemini_CCharacter::Move);
...
void AGemini_CCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGemini_CCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
